...
class Base:
    ...
    def to_json_string(list_dictionaries):
        ...
        if list_dictionaries == None or len(list_dictionaries) < 1:
            return []
    ...
    def from_json_string(json_string):
        '''Static method to return the list of the JSON string representation'''
    ...
    def save_to_file_csv(cls, list_objs):
        ...
        with open(f"{cls.__name__}.csv", mode='w',encoding="utf-8") as f:
            ...
            if cls.__name__ == "Rectangle":
                writer = csv.DictWriter(f, fieldnames=rect_header, lineterminator="\n")
            elif cls.__name__ == "Square":
                writer = csv.DictWriter(f, fieldnames=square_header, lineterminator="\n")
